...
func generateToken(userID int64, ttl time.Duration, scope string) (*Token, error) {
	...
	// Convert the random number to a string and assign it to the token Plaintext field.
	token.Plaintext = strconv.Itoa(randomNumber)
